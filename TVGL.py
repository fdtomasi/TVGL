...
import cvxpy
import snap
import inferGraphL1, inferGraphL2, inferGraphLaplacian, inferGraphLinf, inferGraphPN
...
#    print empCovSet
    ...
    for i in range(timestamps):
        ...
        obj = -cvxpy.log_det(S) + cvxpy.trace(empCovSet[i] * S) #+ alpha*norm(S,1)
        ...
        if (i > 0): #Add edge to previous timestamp
            ...
            edge_obj = beta * cvxpy.norm(currVar['S'] - prevVar['S'], indexOfPenalty) 
